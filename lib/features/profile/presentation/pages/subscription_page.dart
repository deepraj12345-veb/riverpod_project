...
class SubscriptionPage extends ConsumerWidget {
  ...
  void _purchase(BuildContext context, WidgetRef ref, String planName, String price) {
            ...
            return SafeArea(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    CustomText('Complete Payment ($price)',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          ref.read(activeSubscriptionPlanProvider.notifier).state = planName;
