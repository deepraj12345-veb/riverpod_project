...
void main() {
  ...
  // Find bounding box to crop out white/transparent space
  ...
  // Use 60% padding (1.6x) so it perfectly fits in the Android safe zone (Adaptive Icons) without clipping
